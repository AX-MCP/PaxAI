...
### 🏁 Getting Started
  ...
  4. Connect your Agent or AI tool to PAX using the Agent MCP config. Please See: [Quick Start Guide](./Integration_Guides/ax-quick-start-guide.md) or [MCP Setup Guides](#mcp-setup-guides)
